...
export const DEFAULT_XIAOHONGSHU_NPC_FEED_PROMPT = [
  ...
  "",
  "标题要求（会被渲染成小红书式文字封面，很重要）：",
  "- 标题是一句抓人的短钩子，越短越有力，建议 8~18 个字，不要写成完整长句。",
  "- 标题里用 [[ ]] 标出 1~2 个词组作为重点，前端会渲染成红色高亮块。标记词 2~5 个字，不要整句都标。",
  "- 示例：[标题]有没有种[[可能]]你的舍友其实也在上网  /  [标题]这个[[收纳法]]我真的会谢  /  [标题]别再瞎买了[[清单]]在这",
  "- 只能使用 [[ ]] 这一种标记，不要用【】、()、** 等其他写法。",
